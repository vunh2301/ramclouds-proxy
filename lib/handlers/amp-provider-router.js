    ...
    try {
      ...
      if (hasWebSearch) {
        ...
        if (wsBlocks.length > 0) {
          ...
          const wsSystemMsg = "You just performed a web search and received real results. Use these search results to provide a factual, specific answer with sources. Do NOT say you cannot search.";

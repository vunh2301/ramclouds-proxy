 ...
 *   2. Serper.dev         — SERPER_API_KEY (free 2500 queries, Google account only)
 *   3. DuckDuckGo Lite    — No key needed, free, scrapes lite.duckduckgo.com
 *   4. SearXNG            — WEB_SEARCH_URL (free, no key, public or self-hosted)
 *
...
const FALLBACK_CHAINS = {
  brave:      [searchBrave, searchSerper, searchDuckDuckGoHTML, searchBing, searchDuckDuckGo, searchSearXNG],
  serper:     [searchSerper, searchDuckDuckGoHTML, searchBing, searchDuckDuckGo, searchSearXNG],
  bing:       [searchDuckDuckGoHTML, searchBing, searchDuckDuckGo, searchSearXNG],
  duckduckgo: [searchDuckDuckGoHTML, searchDuckDuckGo, searchBing, searchSearXNG],
  searxng:    [searchSearXNG, searchDuckDuckGoHTML, searchBing, searchDuckDuckGo],
};

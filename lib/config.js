...
function getConfig() {
  ...
  const MERGE_TOOL_NAMES = (process.env.MERGE_TOOL_NAMES || "sh,bash,shell,terminal,run_command,execute_command,run_terminal_command").split(",").map(s => s.trim()).filter(Boolean);
